...
entry:
  ...
  %0 = call i1 @lso.store.i32(ptr %arrayidx, i32 1) #1
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  %lso.token.phi2 = phi i1 [ %3, %for.body ], [ %0, %for.body.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ]
  %arrayidx2 = getelementptr inbounds nuw i32, ptr %A, i64 %indvars.iv
  %1 = call i32 @lso.load.i32(ptr %arrayidx2, i1 %lso.token.phi2) #1
